...
with(this){return _c('ul',[_c('li',[_v("needs to be a TA")]),_v(" "),_c('li',[_v("has a need to manage a significant number of student contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that …​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("add a new student's contact")]),_v(" "),_c('td',[_v("I can keep track of all my students in my course")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("view a student's contact information")]),_v(" "),_c('td',[_v("I can contact a student directly if required")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("view a students' grades")]),_v(" "),_c('td',[_v("I can have a comprehensive overview of each students' performance")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("record student grades")]),_v(" "),_c('td',[_v("I can keep accurate records of their performance")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("list out all students")]),_v(" "),_c('td',[_v("I can see who's contacts I have saved")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("view students' attendance")]),_v(" "),_c('td',[_v("I can keep track of when a student has not shown up to class")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("mark students' attendance")]),_v(" "),_c('td',[_v("I can keep track of who goes to class")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("import student contact information from a csv")]),_v(" "),_c('td',[_v("I can quickly add multiple students at once")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("collect students contact information")]),_v(" "),_c('td',[_v("I can keep track and make use of it if required")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Teaching assistant with bad student management ability")]),_v(" "),_c('td',[_v("automate student management")]),_v(" "),_c('td',[_v("I can manage my students better")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Experienced teaching assistant")]),_v(" "),_c('td',[_v("Migrate/get used to the app easily")]),_v(" "),_c('td',[_v("it doesn't take so much time to get used to the new app to increase my productivity")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("tag my students with different labels")]),_v(" "),_c('td',[_v("it is easy for me to find/search them based on their tags")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("link with my Canvas account")]),_v(" "),_c('td',[_v("I can save time exporting grades")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("busy Teaching Assistant")]),_v(" "),_c('td',[_v("view a help message")]),_v(" "),_c('td',[_v("I can quickly learn how to use the app")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("separate my work (TA) contacts with my personal contact")]),_v(" "),_c('td',[_v("I can have privacy and a line between work and life")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant that values privacy")]),_v(" "),_c('td',[_v("sort students by performance metrics like attendance or participation")]),_v(" "),_c('td',[_v("I can identify students who may need additional support.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Helpful Teaching Assistant")]),_v(" "),_c('td',[_v("set up notifications for missing assignment or attendance")]),_v(" "),_c('td',[_v("I can address potential issues with students")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("track communication history with each student")]),_v(" "),_c('td',[_v("I can refer to past discussions when addressing their needs")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("sort student details by name")]),_v(" "),_c('td',[_v("I can view student details in alphabetical order")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("sort student details by grades")]),_v(" "),_c('td',[_v("I can view students who are struggling with the course")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("set up alerts for low attendance or poor participation")]),_v(" "),_c('td',[_v("I can help struggling students early in the course")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Responsible Teaching Assistant")]),_v(" "),_c('td',[_v("attach remarks for each student")]),_v(" "),_c('td',[_v("I can keep track of additional things to remember for each student")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("add a custom column/property on the student database")]),_v(" "),_c('td',[_v("I can personalize my contacts based on my own needs")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Student")]),_v(" "),_c('td',[_v("upload my MC to my TA through the app")]),_v(" "),_c('td',[_v("I can easily send an MC without sending it through other mediums")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("draft an email to the student with a summary of their grades and participation")]),_v(" "),_c('td',[_v("notify students about their progress")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("access and archive past year exam papers")]),_v(" "),_c('td',[_v("I can distribute the practice papers to students")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Student")]),_v(" "),_c('td',[_v("Submit questions to my TA")]),_v(" "),_c('td',[_v("I can easily contact him and get an answer")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("view assignment submission status for each student")]),_v(" "),_c('td',[_v("I can find which students have not submitted assignments")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("create notes for each student")]),_v(" "),_c('td',[_v("I can track any special considerations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("SoC Teaching Assistant")]),_v(" "),_c('td',[_v("Link my account with github")]),_v(" "),_c('td',[_v("I can review my students' code")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Student")]),_v(" "),_c('td',[_v("I can submit feedback to my TA")]),_v(" "),_c('td',[_v("he can improve his teaching")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("view feedback from my students")]),_v(" "),_c('td',[_v("I can improve my teaching")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Teaching Assistant")]),_v(" "),_c('td',[_v("view only feedback scores lower than 2/5")]),_v(" "),_c('td',[_v("I can focus on improving on areas that are more important")])])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"1-use-case-add-a-new-student-contact"}},[_c('strong',[_v("1. Use Case: Add a New Student Contact")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#1-use-case-add-a-new-student-contact","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System:")]),_v(" TAHub"),_c('br'),_v(" "),_c('strong',[_v("Actor:")]),_v(" Teaching Assistant (TA)"),_c('br'),_v(" "),_c('strong',[_v("Use Case ID:")]),_v(" UC01 - Add Contact"),_c('br'),_v(" "),_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("TA adds a new student contact.")]),_v(" "),_c('li',[_v("TAHub displays that the contact has been successfully added.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("1a.")]),_v(" TAHub detects invalid input (e.g., invalid email or phone number)."),_c('br'),_v("\n1a1. TAHub requests correction of the invalid input."),_c('br'),_v("\nUse case ends.")]),_v(" "),_c('li',[_c('strong',[_v("1b.")]),_v(" TAHub detects that the contact already exists"),_c('br'),_v("\n1b1. TAHub ignores the entry and notifies the TA."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actors:")]),_v(" Teaching Assistant")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"2-use-case-view-student-contact-information"}},[_c('strong',[_v("2. Use Case: View Student Contact Information")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#2-use-case-view-student-contact-information","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System:")]),_v(" TAHub"),_c('br'),_v(" "),_c('strong',[_v("Actor:")]),_v(" Teaching Assistant (TA)"),_c('br'),_v(" "),_c('strong',[_v("Use Case ID:")]),_v(" UC02 - View Contact"),_c('br'),_v(" "),_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("TA requests to view a specific student’s contact information.")]),_v(" "),_c('li',[_v("TAHub displays the student's name, phone number, email, Telegram ID, matriculation number, and other relevant details.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("1a.")]),_v(" TA enters a number that is out of bounds or not a number."),_c('br'),_v("\n1a1. TAHub notifies the TA with an error message (e.g., \"Index out of bounds\" or \"Please input a number\")."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actors:")]),_v(" Teaching Assistant")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"3-use-case-record-student-grade"}},[_c('strong',[_v("3. Use Case: Record Student Grade")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#3-use-case-record-student-grade","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System:")]),_v(" TAHub"),_c('br'),_v(" "),_c('strong',[_v("Actor:")]),_v(" Teaching Assistant (TA)"),_c('br'),_v(" "),_c('strong',[_v("Use Case ID:")]),_v(" UC03 - Record Grade"),_c('br'),_v(" "),_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("TA records a grade for a student.")]),_v(" "),_c('li',[_v("TAHub confirms the successful recording of the grade.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("1a.")]),_v(" TAHub detects invalid input for the grade"),_c('br'),_v("\n1a1. TAHub requests correction of the invalid input."),_c('br'),_v("\nUse case ends.")]),_v(" "),_c('li',[_c('strong',[_v("1b.")]),_v(" TA attempts to record a grade for a test that has already been recorded."),_c('br'),_v("\n1b1. TAHub overwrites the previous grade and notifies the TA."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actors:")]),_v(" Teaching Assistant")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"4-use-case-view-student-grades"}},[_c('strong',[_v("4. Use Case: View Student Grades")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#4-use-case-view-student-grades","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System:")]),_v(" TAHub"),_c('br'),_v(" "),_c('strong',[_v("Actor:")]),_v(" Teaching Assistant (TA)"),_c('br'),_v(" "),_c('strong',[_v("Use Case ID:")]),_v(" UC04 - View Grades"),_c('br'),_v(" "),_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("TA views a student’s grades.")]),_v(" "),_c('li',[_v("TAHub displays the student's grades for all tests.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
...
with(this){return _c('h3',{attrs:{"id":"5-use-case-mark-attendance"}},[_c('strong',[_v("5. Use Case: Mark Attendance")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#5-use-case-mark-attendance","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System:")]),_v(" TAHub"),_c('br'),_v(" "),_c('strong',[_v("Actor:")]),_v(" Teaching Assistant (TA)"),_c('br'),_v(" "),_c('strong',[_v("Use Case ID:")]),_v(" UC05 - Mark Attendance"),_c('br'),_v(" "),_c('strong',[_v("Main Success Scenario (MSS):")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("TA records attendance for a student.")]),_v(" "),_c('li',[_v("TAHub outputs the successful recording of attendance.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("1a.")]),_v(" TAHub detects invalid input for the date."),_c('br'),_v("\n1a1. TAHub requests correction of the invalid input."),_c('br'),_v("\n1a2. TA provides corrected input."),_c('br'),_v("\nUse case ends.")]),_v(" "),_c('li',[_c('strong',[_v("1b.")]),_v(" TA attempts to record attendance for a date where attendance has already been marked."),_c('br'),_v("\n1b1. TAHub overwrites the previous attendance and notifies the TA."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actors:")]),_v(" Teaching Assistant")])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Duplicate Entry")]),_v(": An attempt to add a student contact, grade, or record that already exists in the system. TAHub identifies and prevents duplicate entries based on specific criteria (e.g., matriculation number).")]),_v(" "),_c('li',[_c('strong',[_v("Index")]),_v(": A numerical value representing the position of a student’s contact in the TAHub system. TAs use this index to refer to a student’s record in commands.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 7 Nov 2024, 21:26:13 GMT+8]")])])])}
}];
